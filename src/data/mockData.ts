...
export const initialPeople: Person[] = [
  { id: 'p1', name: 'Anna', contact: '@anna_w', contactType: 'instagram', color: personPalette[0], emoji: 'A' },
  { id: 'p2', name: 'Kate', contact: '@kate.daily', contactType: 'instagram', color: personPalette[1], emoji: 'K' },
  { id: 'p3', name: 'Marta', contact: '+39 345 678 9101', contactType: 'phone', color: personPalette[2], emoji: 'M' },
  { id: 'p4', name: 'Leo', contact: '@leo.bites', contactType: 'instagram', color: personPalette[3], emoji: 'L' },
  { id: 'p5', name: 'You', contact: '+39 333 222 1111', contactType: 'phone', color: personPalette[4], emoji: 'Y' }
];
...
export const demoReceipt: ReceiptParseResult = {
  ...
  currency: 'EUR',
  items: [
    { id: 'i1', name: 'Pasta Carbonara', price: 12.5, kcal: 850 },
    { id: 'i2', name: 'Pizza Margherita', price: 14, kcal: 900 },
    { id: 'i3', name: 'Wine Bottle', price: 24, kcal: 620 },
    { id: 'i4', name: 'Dessert', price: 8, kcal: 650 },
    { id: 'i5', name: 'Caesar Salad', price: 9.5, kcal: 420 },
    { id: 'i6', name: 'Fries', price: 5.5, kcal: 480 },
    { id: 'i7', name: 'Sparkling Water', price: 4, kcal: 0 },
    { id: 'i8', name: 'Coffee', price: 3, kcal: 60 }
  ]
};
...
const h1Items: ReceiptItem[] = [
  { id: 'h1-i1', name: 'Pasta Carbonara', price: 12.5, kcal: 850, assignedTo: ['h1-p1'] },
  { id: 'h1-i2', name: 'Pizza Margherita', price: 14, kcal: 900, assignedTo: ['h1-p2'] },
  { id: 'h1-i3', name: 'Wine Bottle', price: 24, kcal: 620, assignedTo: ['h1-p1', 'h1-p2', 'h1-p3', 'h1-p4'] },
  { id: 'h1-i4', name: 'Dessert', price: 8, kcal: 650, assignedTo: ['h1-p1', 'h1-p4'] },
  { id: 'h1-i5', name: 'Caesar Salad', price: 9.5, kcal: 420, assignedTo: ['h1-p3'] },
  { id: 'h1-i6', name: 'Coffee', price: 3, kcal: 60, assignedTo: ['h1-p4'] }
];
...
const h2Items: ReceiptItem[] = [
  { id: 'h2-i1', name: 'Flat White', price: 4.5, kcal: 120, assignedTo: ['h2-p1'] },
  { id: 'h2-i2', name: 'Latte', price: 4.9, kcal: 130, assignedTo: ['h2-p2'] },
  { id: 'h2-i3', name: 'Blueberry Muffin', price: 3.5, kcal: 350, assignedTo: ['h2-p1', 'h2-p2'] }
];
...
const h3Items: ReceiptItem[] = [
  { id: 'h3-i1', name: 'Classic Burger', price: 12.5, kcal: 950, assignedTo: ['h3-p1'] },
  { id: 'h3-i2', name: 'Fries', price: 4.5, kcal: 480, assignedTo: ['h3-p2'] },
  { id: 'h3-i3', name: 'Chicken Salad', price: 10.0, kcal: 420, assignedTo: ['h3-p3'] },
  { id: 'h3-i4', name: 'Shared Nachos', price: 8.0, kcal: 800, assignedTo: ['h3-p1', 'h3-p2', 'h3-p3'] }
];
