...
export function ReceiptReviewScreen({
    ...
    const [items, setItems] = useState<ReceiptItem[]>(initialItems.map((i) => ({ ...i })));
    ...
    function addItem() {
        ...
        setItems((cur) => [...cur, { id, name: 'New item', price: 0, assignedTo: [] }]);
    }
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.screen}>
            <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
                <View style={styles.headerCard}>
                    ...
                    <Text style={styles.sub}>Detected from {merchant}. Edit items, prices, or add missing items.</Text>
                </View>
